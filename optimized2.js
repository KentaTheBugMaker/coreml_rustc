function main() {
    ...
    let var_128 = (var_115).tuple_1; /* [AH,AG.{tuple_1:({tuple_1:AG,tuple_2:AH} -> AH),tuple_2:int}] */
    let var_129 = (var_128).env; /* ({tuple_1:AG,tuple_2:AH} -> AH) */
    let var_131 = (var_115).tuple_1; /* [AH,AG.{tuple_1:({tuple_1:AG,tuple_2:AH} -> AH),tuple_2:int}] */
